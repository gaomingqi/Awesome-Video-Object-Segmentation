...
<span style="display:inline-block;width:15px;height:15px;background-color:#FF0000;margin-right:5px;"></span> 红色 (Red)

<span style="display:inline-block;width:15px;height:15px;background-color:#00FF00;margin-right:5px;"></span> 绿色 (Green)

<span style="display:inline-block;width:15px;height:15px;background-color:#0000FF;margin-right:5px;"></span> 蓝色 (Blue)

<span style="display:inline-block;width:15px;height:15px;background-color:#FFFF00;margin-right:5px;"></span> 黄色 (Yellow)
...
:blue_square: `SVOS` :orange_square: `RVOS` &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp; [LSVOS @ECCV 2024](https://lsvos.github.io/) 🔥ACTIVE!🔥

:blue_square: `SVOS` &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp; [VOTS @ECCV 2024](https://www.votchallenge.net/)

:blue_square: `SVOS` :orange_square: `RVOS` &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp; [PVUW @CVPR 2024](https://www.vspwdataset.com/Workshop2024.html)
...
:blue_square: `SVOS` `Jul` &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp; [paper](https://arxiv.org/abs/2404.06265) / code &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp; Learning Spatial-Semantic Features for Robust Video Object Segmentation
...
:blue_square: `SVOS` &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp; [paper](https://arxiv.org/abs/2407.07760) / [code](https://github.com/yahooo-m/VOS-Solution) &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp; Spatial-Temporal Multi-level Association for Video Object Segmentation
